...
export default function ResDetails(){
    ...
    return(
        <div className = "resDet-container">
            ...
            {redProps.item.source=="Zomato" ? <div className="gotoButton" style={{backgroundColor:"rgb(245,67,75)"}}>
                    <p>Go to {redProps.item.source}</p>
            </div> : 
            <div className="gotoButton" style={{backgroundColor:"rgb(243,132,33)"}}>
                    <p>Go to {redProps.item.source}</p>
            </div>}
            ...
            <p style = {{margin:0, fontSize:'24px', fontWeight:'bold',fontFamily:'Jura'}}>{redProps.item.name}</p>
